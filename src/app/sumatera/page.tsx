            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {(() => {
                const poskoData: Record<string, { kota: string; lokasi: string; nama: string; jabatan: string; kontak: string[] }[]> = {
                  ...
                  'Sumatera Utara': [
                    { kota: "Medan", lokasi: "Kantor BPBD Kota Medan", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0618454900 (tidak aktif)"] },
                    { kota: "Deli Serdang", lokasi: "Kantor BPBD Deli Serdang", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0617030007 (tidak aktif)"] },
                    { kota: "Langkat", lokasi: "Kantor BPBD Langkat", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0618913255 (tidak aktif)"] },
                    { kota: "Karo", lokasi: "Kantor BPBD Karo", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0628320110 (tidak aktif)"] },
                    { kota: "Simalungun", lokasi: "Kantor BPBD Simalungun", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0622437770 (tidak aktif)"] },
                    { kota: "Asahan", lokasi: "Kantor BPBD Asahan", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0623341234 (tidak aktif)"] },
                    { kota: "Labuhanbatu", lokasi: "Kantor BPBD Labuhanbatu", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0624421700 (tidak aktif)"] },
                    { kota: "Tapanuli Utara", lokasi: "Kantor BPBD Tapanuli Utara", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0633331125 (tidak aktif)"] },
                    { kota: "Nias", lokasi: "Kantor BPBD Nias", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0639321021 (tidak aktif)"] },
                    { kota: "Binjai", lokasi: "Kantor BPBD Binjai", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0618821800 (tidak aktif)"] },
                  ],
                  'Sumatera Barat': [
                    { kota: "Padang", lokasi: "Kantor BPBD Kota Padang", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0751811120 (tidak aktif)"] },
                    { kota: "Bukittinggi", lokasi: "Kantor BPBD Bukittinggi", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0752625555 (tidak aktif)"] },
                    { kota: "Payakumbuh", lokasi: "Kantor BPBD Payakumbuh", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0752796699 (tidak aktif)"] },
                    { kota: "Padang Panjang", lokasi: "Kantor BPBD Padang Panjang", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0752485555"] },
                    { kota: "Solok", lokasi: "Kantor BPBD Kota Solok", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0755324455 (tidak aktif)"] },
                    { kota: "Agam", lokasi: "Kantor BPBD Agam", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0752765432 (tidak aktif)"] },
                    { kota: "Tanah Datar", lokasi: "Kantor BPBD Tanah Datar", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0752571234 (tidak aktif)"] },
                    { kota: "Pesisir Selatan", lokasi: "Kantor BPBD Pesisir Selatan", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0756211100 (tidak aktif)"] },
                    { kota: "Sijunjung", lokasi: "Kantor BPBD Sijunjung", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0754831234 (tidak aktif)"] },
                    { kota: "Dharmasraya", lokasi: "Kantor BPBD Dharmasraya", nama: "Kepala BPBD", jabatan: "Kepala Pelaksana BPBD", kontak: ["0754401234 (tidak aktif)"] },
                  ],
                };
