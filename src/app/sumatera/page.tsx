...
// Data Logistik Stok PMI (sumber: pmi.or.id/dashboard/stock - 9 Desember 2025 pukul 11.16)
// Total: 141 item
const pmiStockData = [
  ...
  { id: 84, name: 'Makanan Ringan', icon: 'fa-cookie', quantity: '129.428 KARTON' },
  ...
  { id: 91, name: 'Mie Instan', icon: 'fa-bowl-rice', quantity: '11.407 KARTON' },
  { id: 92, name: 'Minuman Energy', icon: 'fa-bottle-water', quantity: '7.186 PCS' },
  { id: 93, name: 'Minuman Kemasan Botol', icon: 'fa-bottle-water', quantity: '231 KARTON' },
  { id: 94, name: 'Minuman Sachet', icon: 'fa-mug-hot', quantity: '63 KARTON' },
  { id: 95, name: 'Minyak Goreng 1 L', icon: 'fa-bottle-droplet', quantity: '853 KARTON' },
  { id: 96, name: 'Minyak Kayu Putih', icon: 'fa-bottle-droplet', quantity: '1.300 PCS' },
  ...
  { id: 99, name: 'Obat-Obatan', icon: 'fa-pills', quantity: '925 KARTON' },
  ...
  { id: 104, name: 'Pakaian Dewasa', icon: 'fa-shirt', quantity: '25.631 PCS' },
  { id: 105, name: 'Paket Sembako', icon: 'fa-box', quantity: '4.123 BAG' },
  ...
  { id: 109, name: 'Pembalut Wanita', icon: 'fa-box', quantity: '933 KARTON' },
  { id: 110, name: 'Pembalut Wanita', icon: 'fa-box', quantity: '2.053 PCS' },
  ...
  { id: 115, name: 'Perlengkapan Bayi', icon: 'fa-baby', quantity: '10 BALE' },
  ...
  { id: 118, name: 'Perlengkapan Ibadah', icon: 'fa-mosque', quantity: '67 BALE' },
  ...
  { id: 124, name: 'Pompa Air', icon: 'fa-faucet', quantity: '7 UNIT' },
  { id: 125, name: 'Popok Anak', icon: 'fa-baby', quantity: '2.290 KARTON' },
  ...
  { id: 135, name: 'Sabun Mandi', icon: 'fa-soap', quantity: '1.197 BOX' },
  ...
  { id: 139, name: 'Sarden', icon: 'fa-fish', quantity: '1.296 KARTON' },
  ...
  { id: 152, name: 'Selimut', icon: 'fa-bed', quantity: '7 BALE' },
  { id: 153, name: 'Selimut', icon: 'fa-bed', quantity: '11.329 PCS' },
  { id: 154, name: 'Selimut A2025', icon: 'fa-bed', quantity: '3.817 PCS' },
  ...
  { id: 159, name: 'Seragam Sekolah', icon: 'fa-shirt', quantity: '932 PCS' },
  ...
  { id: 173, name: 'Susu Kaleng', icon: 'fa-mug-hot', quantity: '205 KALENG' },
  { id: 174, name: 'Susu Kotak', icon: 'fa-mug-hot', quantity: '3.012 KARTON' },
  ...
  { id: 208, name: 'Tissue', icon: 'fa-box-tissue', quantity: '96 KARTON' },
  ...
  { id: 216, name: 'Vitamin C', icon: 'fa-pills', quantity: '889 KARTON' },
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-10">
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-sm text-gray-500">
              Pembaruan Terakhir: <span className="font-semibold">9 Desember 2025 pukul 11.16</span>
            </p>
          </div>
